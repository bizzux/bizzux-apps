...
export async function resolveAccount(uid) {
  ...
  return { accountId: m.accountId, profile: m.profile || "Staff/Operator", isOwner: false, membership: m };
}

// Global Admin and Admin can manage the team and account-level config;
// Manager/Staff-Operator/Viewer-Auditor can't (see ACCOUNT_ADMIN_PROFILES).
